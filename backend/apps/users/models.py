...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    def clean(self):
        super().clean()
        if self.rol in (self.Role.ADMIN, self.Role.COORDINATOR) and self.coordinador_id is not None:
    ...
    def is_admin(self) -> bool:
        return self.is_superuser or self.is_staff or self.rol == self.Role.ADMIN
