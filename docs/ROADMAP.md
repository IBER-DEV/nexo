...
arquitectura técnica y monetización en un solo archivo de 600 líneas. Empieza por el que
responda tu pregunta:

- **[roadmap/product.md](roadmap/product.md)** — qué es Nexo, el modelo Open Core (qué va en
  cada plan), diferenciadores de producto, features de Fase 2 (Enterprise).
