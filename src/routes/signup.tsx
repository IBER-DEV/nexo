...
import { Mail, Lock, User as UserIcon, Building2, ArrowRight } from "lucide-react";
...
function SignupPage() {
  ...
  const form = useForm<FormValues>({
    ...
    defaultValues: { nombre: "", email: "", password: "", nombre_org: "", template: "" },
  });
          ...
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              {form.formState.errors.template && (
                <p className="text-xs text-destructive">{form.formState.errors.template.message}</p>
              )}
            </div>
